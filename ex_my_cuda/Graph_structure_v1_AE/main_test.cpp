...
int main(int argc, char **argv)
{
    ...
    MY_MATRIX_DEVICE *u1,*noise, *r1,*r1_drop, *r2,*r2_drop, *r3,*r3_drop, *r4,*r4_drop, *r5,*r6;
  ...
  //  r1 = net.min(net.adding_point(u1,noise),1);
    ...
    get_mnist_image("normalNet_input", u1);
 
 
    get_mnist_image("normalNet_output", r5);
