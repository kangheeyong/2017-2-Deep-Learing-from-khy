...
//    my_para_read("resNet_v3/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
    ...
    maxnorm.set_para(MAX_NORM,4.0,w1,w2,w3,w4,w5,w6,w7,NULL);
  ...
  //      maxnorm.update();
    ...
    get_mnist_image("resNet_v3/resNet_input", x4);
 

    get_mnist_image("resNet_v3/resNet_ref_input", u2);
 
    get_mnist_image("resNet_v3/resNet_output", r24);
    ...
    my_para_write("resNet_v3/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
