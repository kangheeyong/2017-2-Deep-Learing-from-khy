...
int main(int argc, char **argv)
{
    ...
    my_para_read("resNet_v4/para.txt",w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
    ...
    r36 = net.elu(net.add_bias(net.multi(w7,r34),b7));
    r37 = net.adding_point(r36,r35);
    ...
    r44 = net.elu(net.add_bias(net.multi(w9,r42),b9));
    r21 = net.adding_point(r44,r43);
    ...
    adam.set_hyperpara(0.001);

    adam.set_para(w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
    maxnorm.set_para(MAX_NORM,4.0,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,NULL);
    ...
    get_mnist_image("resNet_v4/resNet_input", x4);
 

    get_mnist_image("resNet_v4/resNet_ref_input", u2);
 
    get_mnist_image("resNet_v4/resNet_output", r24);
    ...
    //my_para_write("resNet_v4/para.txt",w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
