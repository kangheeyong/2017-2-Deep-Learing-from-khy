...
int main(int argc, char **argv)
{
    ...
    MY_MOMENTUM_OPTIMIZER momentum;

    MY_MATRIX_DEVICE *u1,*u2,*noise, *r1,*r2,*r3,*r4,*r5,*r6,*r7,*r8,*r9,*r10,
                     *r11,*r12,*r13,*r14,*r15,*r16,*r17,*r18,*r19,*r20,
                     *r21,*r22,*r23,*r24,*r25;
    MY_MATRIX_DEVICE *r31, *r32, *r33, *r34, *r35, *r36, *r37, *r38, *r39, *r40,
                     *r41, *r42,*r43, *r44;

    MY_MATRIX_DEVICE *w1, *w2, *w3, *w4, *w5, *w6, *w7,*b1, *b2, *b3, *b4, *b5, *b6, *b7;
    MY_MATRIX_DEVICE *w8, *w9, *w10, *w11,*b8, *b9, *b10, *b11;
    ...
    b7 = para.set("b7",n8);
    w8 = para.set("w8",n9,n8);
    b8 = para.set("b8",n9);
    w9 = para.set("w9",n10,n9);
    b9 = para.set("b9",n10);
    w10 = para.set("w10",n11,n10);
    b10 = para.set("b10",n11);
    w11 = para.set("w11",n12,n11);
    b11 = para.set("b11",n12);
    ...
    //float mean = 0.0;
    //float std = 0.01;
    //my_set_gaussian(mean,std,w1,w2,w3,w4,w5,w6,w7,w8,w9,w11,NULL);

    my_para_read("resNet_v5/para.txt",w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
    MY_MATRIX_DEVICE *x1,*x2,*x3,*x4,*x5,*x6,*x7;


    pre_process.dividing_point(u2,&x1,&x2);

    x6 = pre_process.rand_scale(x2,0.0,1.0);
    x3 = pre_process.adding_point(u1,x6);

    noise = pre_process.white_noise(n1/2,mini_batch_size,0.5);

    x7 = pre_process.adding_point(x3,noise);


    x4 = pre_process.min(x7,1.0);
    x5 = pre_process.merge(x4,x1);
...
//    net.dividing_point(r9,&r10,&r11);
    r12 = net.elu(net.add_bias(net.multi(w3,r8),b3));
    r13 = net.adding_point(r12,r7);
 ...
 //   net.dividing_point(r17,&r18,&r19);
    r20 = net.elu(net.add_bias(net.multi(w5,r16),b5));
    r21 = net.adding_point(r20,r15);

    net.dividing_point(r21,&r31,&r32);
    r23 = net.elu(net.add_bias(net.multi(w6,r31),b6));
 //   r33 = net.adding_point(r23,r32);

 //   net.dividing_point(r33,&r34,&r35);
    r36 = net.elu(net.add_bias(net.multi(w7,r23),b7));
    r37 = net.adding_point(r36,r32);

    net.dividing_point(r37,&r38,&r39);
    r40 = net.elu(net.add_bias(net.multi(w8,r38),b8));
//    r41 = net.adding_point(r40,r39);

//    net.dividing_point(r41,&r42,&r43);
    r44 = net.elu(net.add_bias(net.multi(w9,r40),b9));
    r21 = net.adding_point(r44,r39);

    r22 = net.elu(net.add_bias(net.multi(w10,r21),b10));
    r23 = net.adding_point(r22,r4);

    r24 = net.sigmoid(net.add_bias(net.multi(w11,r23),b11));
    ...
    adam.set_hyperpara(0.00000005);
    adam.set_para(w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
    maxnorm.set_para(MAX_NORM,3.0,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,NULL);
    ...
    get_mnist_image("resNet_v5/resNet_input", x4);
 

    get_mnist_image("resNet_v5/resNet_ref_input", u2);
 
    get_mnist_image("resNet_v5/resNet_output", r24);
    ...
    my_para_write("resNet_v5/para.txt",w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,NULL);
