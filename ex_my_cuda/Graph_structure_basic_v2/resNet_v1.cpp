...
int main(int argc, char **argv)
{
 ...
 //   my_set_gaussian(mean,std,w1,w2,w3,w4,w5,w6,w7,NULL);
    ...
    my_para_read("resNet_v1/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
   ...
   //     maxnorm.update();
    ...
    get_mnist_image("resNet_v1/resNet_input", x4);
 

    get_mnist_image("resNet_v1/resNet_ref_input", u2);
 
    get_mnist_image("resNet_v1/resNet_output", r24);
    ...
    my_para_write("resNet_v1/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
