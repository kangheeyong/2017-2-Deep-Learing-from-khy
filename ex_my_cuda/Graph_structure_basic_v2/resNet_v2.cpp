...
int main(int argc, char **argv)
{
   ...
   // float mean = 0.0;
    ...
    my_para_read("resNet_v2/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
    MY_MATRIX_DEVICE *x1,*x2,*x3,*x4,*x5,*x6;
    ...
    get_mnist_image("resNet_v2/resNet_input", x4);
 

    get_mnist_image("resNet_v2/resNet_ref_input", u2);
 
    get_mnist_image("resNet_v2/resNet_output", r24);
    ...
    my_para_write("resNet_v2/para.txt",w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7,NULL);
