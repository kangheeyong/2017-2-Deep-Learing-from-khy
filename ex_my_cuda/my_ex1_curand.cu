...
*/
    ...
    //curandGenerateNormal(gen,d_matrix1,m*k,0,0.1);
    curandGenerateUniform(gen,d_matrix1,m*k);
    curandGenerateUniform(gen,d_matrix2,k*n);
    curandGenerateUniform(gen,d_matrix3,m*n);
 stat = cublasSgemm(handle,  CUBLAS_OP_T,CUBLAS_OP_N,m-4,n-2,k-3,  &al,  d_matrix1+m,m,  d_matrix2,k,  &bet,  d_matrix3,m);
     curandGenerateUniform(gen,d_matrix1,m*k);
    curandGenerateUniform(gen,d_matrix2,k*n);
    curandGenerateUniform(gen,d_matrix3,m*n);
