...
long neurals[5] = {784,40,30,20,10};
long layers = 5;
...
int main(int argc,char **argv)
{
    ...
    if(argc != 4)
    {
        printf("USAGE : %s [learning rate] [batch size] [maxnorm]\n",argv[0]);
        exit(1);
    }
