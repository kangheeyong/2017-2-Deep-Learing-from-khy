...
int main(int argc, char **argv)
{
    ...
    MY_MATRIX_DEVICE *u1,*noise, *r1,*r2,*r3,*r4,*r5,*r6,*r7,*r8,*r9,*r10,
  ...
  //  my_set_gaussian(mean,std,w1,w2,w3,w4,w5,w6,w7,NULL);
    ...
    get_mnist_image("resNet_input", u1);
 

    get_mnist_image("resNet_noise_input", r1);
