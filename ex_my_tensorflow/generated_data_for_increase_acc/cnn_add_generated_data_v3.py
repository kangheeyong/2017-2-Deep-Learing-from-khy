...
new_saver = tf.train.import_meta_graph('../ex_basic_5/para.cktp.meta')
new_saver.restore(sess, tf.train.latest_checkpoint('../ex_basic_5/'))
...
for i in range(1000000) :
    ...
    cnn_z = np.random.normal(0,1.0,size=(100,1,1,100))
    ...
    cnn_input = np.reshape(gen_d,(-1,28,28,1))
    cnn_target = np.reshape(cnn_z_c,(-1,10))
    ...
    if i%1000 == 0:
        ...
        print('cnn_t_e : %.2f, cnn_t_acc : %.2f, test acc : %.6f'%(e,acc,test_acc))
