...
def simple_dcnn(x,ref,isTrain = True, name = 'y') : #input = (minibatch * w * h * ch)
    ...
    with tf.variable_scope('dcnn') :
        ...
        conv1 = tf.layers.batch_normalization(tf.concat([conv1_ref,conv1_u],3),training=isTrain)
...
y = simple_dcnn(u,ref,isTrain=isTrain,name='y')
