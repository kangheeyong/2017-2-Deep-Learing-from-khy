...
W1 = tf.Variable(tf.random_normal(shape = [784, 2048], mean = 0,stddev = 0.1))
b1 = tf.Variable(tf.random_normal(shape = [2048], mean = 0,stddev = 0.001))
W2 = tf.Variable(tf.random_normal(shape = [2048, 2048], mean = 0,stddev = 0.1))
b2 = tf.Variable(tf.random_normal(shape = [2048], mean = 0,stddev = 0.001))
W3 = tf.Variable(tf.random_normal(shape = [2048, 2048], mean = 0,stddev = 0.1))
b3 = tf.Variable(tf.random_normal(shape = [2048], mean = 0,stddev = 0.001))
