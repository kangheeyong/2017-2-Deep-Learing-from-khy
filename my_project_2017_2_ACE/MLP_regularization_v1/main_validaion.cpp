...
long neurals[5] = {784,2048,2048,2048,10};
long layers = 5;
...
int main(int argc,char **argv)
{
    ...
    alpha = (rand()%9 + 1)*pow(10,-(rand()% 5 + 2)); // 0.09 ~ 0.000001
    train_batch_size =  rand()%500 + 50; //50~550
    maxnorm_constraints = (rand()%40 + 15)/10.0; // 1.5~5.5
    ...
    make_index(validation_batch_size - train_batch_size);
